    ...
    return (
      <div className="flex flex-col items-center justify-center p-24 gap-4 bg-white dark:bg-zinc-950 rounded-2xl min-h-[60vh]">
        ...
        <div className="flex flex-col items-center animate-pulse">
            <p className="text-zinc-900 dark:text-zinc-100 font-semibold text-lg">Quản Lý Bàn</p>
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <Settings className="w-4 h-4" /> {isEditMode ? "Xong" : "Chỉnh sửa"}
          </button>
          
          <div className="hidden lg:flex items-center gap-4 px-3 py-2 bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-lg text-xs">
            <div className="flex items-center gap-2">
              <div className="w-2.5 h-2.5 rounded-full bg-emerald-500" />
              <span className="text-zinc-600 dark:text-zinc-400 font-medium">Trống</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-2.5 h-2.5 rounded-full bg-rose-500" />
              <span className="text-zinc-600 dark:text-zinc-400 font-medium">Có khách</span>
            </div>
          </div>
        </div>
      </div>
        ...
        {tables.map((table) => {
          ...
          return (
            <button 
              ...
              className={`relative aspect-square rounded-lg flex flex-col items-center justify-center border-2 transition-all hover:scale-105 cursor-pointer ${
                isEditMode 
                  ? "bg-zinc-50 dark:bg-zinc-800 border-dashed border-zinc-200 dark:border-zinc-700" 
                  : isOccupied 
                    ? "bg-rose-50 dark:bg-rose-950/20 border-rose-100 dark:border-rose-900/30 hover:shadow-md" 
                    : "bg-white dark:bg-zinc-900 border-zinc-100 dark:border-zinc-800 hover:shadow-md"
              }`}
            >
              {isEditMode && (
                <div className="absolute bottom-3 left-0 right-0 text-center">
                  <span className="text-[9px] font-medium text-zinc-400">Sửa</span>
                </div>
              )}
